...
random_number_data_number = Math.floor((Math.random() * quick_draw_data_set.length)+1);
console.log(random_number_data_number);
Element_of_array = quick_draw_data_set[random_number_data_number];
